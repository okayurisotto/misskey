...
import { BACKEND_STATIC_ASSETS_DIR, FLUENT_EMOJIS_DIST_DIR, FRONTEND_ASSETS_DIR, FRONTEND_STATIC_ASSETS_DIR, SW_ASSETS_DIR, TWEMOJI_DIST_DIR, VIEW_DIR, VITE_DIR } from '@/paths.js';
