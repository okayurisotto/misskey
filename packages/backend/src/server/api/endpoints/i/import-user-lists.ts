...
import ms from 'ms';
import {
	noSuchFile_____________,
	unexpectedFileType___,
	tooBigFile___,
	emptyFile____,
...
export const meta = {
	...
	errors: {
		noSuchFile: noSuchFile_____________,
		unexpectedFileType: unexpectedFileType___,
		tooBigFile: tooBigFile___,
		emptyFile: emptyFile____,
	},
} as const;
