...
import { noSuchUser_____, followeeIsYourself_, notFollowing } from '@/server/api/errors.js';
...
export const meta = {
	...
	errors: {noSuchUser:noSuchUser_____,followeeIsYourself:followeeIsYourself_,notFollowing:notFollowing},
	res,
} as const;
